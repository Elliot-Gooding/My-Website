...
function preload() {
    ...
    const planet1   =  loadImage("./images/planet1.png");
    const planet2   =  loadImage("./images/planet2.png");
    const planet3   =  loadImage("./images/planet3.png");
    const planet4   =  loadImage("./images/planet4.png");
