...
document.getElementById("renderer-button").addEventListener('click', handleRendererButton);
...
function handleRendererButton(e){
...
function refuseRenderer(){
    const button = document.getElementById("renderer-button");
    const error = document.getElementById("renderer-error");
    button.style.setProperty('--colour1', 'rgb(255,0,0)');
    button.style.setProperty('--colour2', 'rgb(255,0,0)');
    button.classList.add("shake");
    error.style.opacity = 1;
    setTimeout(() => {
        button.style.removeProperty('--colour1');
        button.style.removeProperty('--colour2');
